...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_properties_status" AS ENUM('for-sale', 'sold-out', 'under-contract');
  ...
  ALTER TABLE "properties_floor_plans" ADD CONSTRAINT "properties_floor_plans_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "properties" ADD CONSTRAINT "properties_card_image_id_media_id_fk" FOREIGN KEY ("card_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "properties_floor_plans_image_idx" ON "properties_floor_plans" USING btree ("image_id");
  ...
  CREATE INDEX "properties_card_image_idx" ON "properties" USING btree ("card_image_id");
