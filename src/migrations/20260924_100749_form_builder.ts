...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "properties" ADD COLUMN "featured_display_name" varchar;
  ...
  // Create the Buy A Home, Trade Inquiry and Other Inquiries forms (skipped if they exist).
  await seedContactForms(payload, req)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "properties" DROP COLUMN "featured_display_name";
